...
Deno.test('should fetch valid application data', async (t) => {
  const app = await gplay.app({appId: 'com.sgn.pandapop.gp'})
...
Deno.test('should fetch valid application data for country: es', () => {
  return gplay.app({
...
Deno.test('should fetch valid application data for country: br', () => {
  return gplay.app({
    appId: 'com.sgn.pandapop.gp',
    country: 'br',
    lang: 'pt'
...
Deno.test('should properly parse a VARY android version', () => {
...
Deno.test('should get the developer physical address', () => {
...
Deno.test('should get the privacy policy', () => {
  return gplay.app({appId: 'com.snapchat.android'})
    .then((app) => {
...
Deno.test('should fetch app in spanish', () => {
...
Deno.test('should fetch app in french', () =>
...
Deno.test('should reject the promise for an invalid appId', () =>
...
Deno.test('should reject the promise when appId is not passed', () =>
  // @ts-ignore
...
Deno.test('should fetch PriceText for paid apps properly', () => {
...
Deno.test('should fetch valid internal developer_id, if it differs from developer_id', () => {
...
Deno.test('should fetch available false for an app is unavailable in country', () => {
