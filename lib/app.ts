import {queryString, R} from "../deps.ts"
import request from "./utils/request.ts";
import * as scriptData from "./utils/scriptData.ts"
import {BASE_URL} from "./constants.ts";
import * as helper from "./utils/mappingHelpers.ts"
import type {AppItemFullDetail} from "./interfaces/app/appItem.ts";
import {AppRequestOptions} from "./interfaces/app/appRequestOptions.ts";

const PLAYSTORE_URL = `${BASE_URL}/store/apps/details`;

function app (opts: AppRequestOptions): Promise<AppItemFullDetail> {
