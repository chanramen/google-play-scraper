import {R, debug as debugInit} from "../deps.ts"
import request from "./utils/request.ts";
import * as scriptData from "./utils/scriptData.ts"
import {BASE_URL} from "./constants.ts";
import * as c from "./constants.ts"
import {PermissionsRequestOptions} from "./interfaces/permissions/permissionsRequestOptions.ts";
import {PermissionItem} from "./interfaces/permissions/permissionItem.ts";
const debug = debugInit('google-play-scraper:permissions');

function permissions (opts: PermissionsRequestOptions): Promise<PermissionItem[]> {
