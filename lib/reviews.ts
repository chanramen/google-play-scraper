...
import {ReviewsRequestOptions} from "./interfaces/reviews/reviewsRequestOptions.ts";
import {ReviewItem, ReviewsPaginationData} from "./interfaces/reviews/reviewItem.ts";
const debug = debugInit('google-play-scraper:reviews');

function reviews (opts: ReviewsRequestOptions): Promise<ReviewsPaginationData> {
